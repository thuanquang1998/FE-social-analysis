...
function ChannelsTiktok(props) {
    ...
    return (
        <MainCard title="Channels Tiktok" secondary={<ButtonCreate title="Add Channel" handleClick={() => setShowModalCreate(true)} />}>
